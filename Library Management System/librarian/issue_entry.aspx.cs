...
namespace Library_Management_System.librarian
{
    ...
    String isbn = "";
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "select * from stud_issue_return where id="+id;
            cmd.ExecuteNonQuery();
            ...
            if(i>0)
            {
                ...
                cmd1.CommandText = "update stud_issue_return set is_return='no' , issue_date='"+ issue_date +"',approx_return_date='"+ approx_return_date + "' where  isbn='" + isbn + "'";
        ...
        {
            Response.Redirect("Stud_issue_entries.aspx");
        }
    }
}