<%@ Page Title="" Language="C#" MasterPageFile="~/librarian/librarian_menu.Master" AutoEventWireup="true" CodeBehind="stud_new.aspx.cs" Inherits="Library_Management_System.librarian.stud_new" %>
    ...
    <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <center> <strong class="card-title">New Students</strong></center>
