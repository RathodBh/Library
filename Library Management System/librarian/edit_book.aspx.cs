    ...
    protected void Page_Load(object sender, EventArgs e)
        {
            ...
            cmd0.CommandText = "select * from book_info";
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            SqlCommand cmd0 = con.CreateCommand();
            cmd0.CommandType = CommandType.Text;
            cmd0.CommandText = "select * from book_info where bnm like '%'+'" + TextBox2.Text + "'+'%' or qty like '%'+'" + TextBox2.Text + "'+'%'  or isbn like '%'+'" + TextBox2.Text + "'+'%' or bauthor like '%'+'" + TextBox2.Text + "'+'%' or lang like '%'+'" + TextBox2.Text + "'+'%' or place like '%'+'" + TextBox2.Text + "'+'%' or price like '%'+'" + TextBox2.Text + "'+'%'";
