...
namespace Library_Management_System.librarian
{
    public partial class display_stud_info : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            cmd0.CommandText = "select * from stud_reg where eno like '%'+'" + TextBox2.Text + "'+'%' or snm like '%'+'" + TextBox2.Text + "'+'%'  or email like '%'+'" + TextBox2.Text + "'+'%' or ph like '%'+'" + TextBox2.Text + "'+'%' or simg like '%'+'" + TextBox2.Text + "'+'%' or approved like '%'+'" + TextBox2.Text + "'+'%' or stream like '%'+'" + TextBox2.Text + "'+'%' or sem like '%'+'" + TextBox2.Text + "'+'%'";
