...
namespace Library_Management_System.librarian
{
    public partial class WebForm4 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "select * from teacher_reg";
            cmd.ExecuteNonQuery();
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            cmd0.CommandText = "select * from teacher_reg where tid like '%'+'" + TextBox2.Text + "'+'%' or tnm like '%'+'" + TextBox2.Text + "'+'%'  or email like '%'+'" + TextBox2.Text + "'+'%' or ph like '%'+'" + TextBox2.Text + "'+'%' or dept like '%'+'" + TextBox2.Text + "'+'%' or approved like '%'+'" + TextBox2.Text + "'+'%' ";
