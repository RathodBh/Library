<%@ Page Title="" Language="C#" MasterPageFile="~/librarian/librarian_menu.Master" AutoEventWireup="true" CodeBehind="teacher_new.aspx.cs" Inherits="Library_Management_System.librarian.teacher_new" %>
    ...
    <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <center>
                            <strong class="card-title">New Teachers </strong>
                                </center>
                        </div>
                         <div class="card-header">
                             <form runat="server">
