...
{
    public partial class teacher_new : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "select * from teacher_reg where approved='new'";
            cmd.ExecuteNonQuery();
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            cmd0.CommandText = "select * from teacher_reg where approved='new' and (tid like '%'+'" + TextBox2.Text + "'+'%' or tnm like '%'+'" + TextBox2.Text + "'+'%'  or email like '%'+'" + TextBox2.Text + "'+'%' or ph like '%'+'" + TextBox2.Text + "'+'%' or dept like '%'+'" + TextBox2.Text + "'+'%' or approved like '%'+'" + TextBox2.Text + "'+'%' ) ";
