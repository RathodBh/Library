<%@ Page Title="" Language="C#" MasterPageFile="~/student/student_menu.Master" AutoEventWireup="true" CodeBehind="stud_send_msg.aspx.cs" Inherits="Library_Management_System.student.send_msg" %>
<asp:Content ID="Content1" ContentPlaceHolderID="c1" runat="server">
   <style type="text/css">
    ...
    <div class="row" style="margin:10px;">
         <div class="col-lg-12" style="height:40px; border: 2px solid green;border-radius:10px; justify-content:right;  background:#fff url('../librarian/images/msg.png') no-repeat; margin-top:10px;display:grid;place-items:right;">  
         
             
             <a href="stud_home.aspx" style="border-radius:50%;border:1px solid black; color:black;margin:5px 0px;padding:0px 7px ; "><i class="fa fa-close"></i></a>
        ...
        <div class="col-lg-12" style="height:60vh; border: 2px solid black; background-color:white; overflow:auto;" id="msgarea"  >
         ...
         <div class="col-lg-12" style="height:80px;border-radius:20px; border-style:solid; border-width: 2px; background-color:white; margin-top:5px;">
             <div class="col-lg-10">
                ...
                <%-- <asp:TextBox id="t1" class="form-control" runat="server"></asp:TextBox>--%>
             </div>
             <div class="col-lg-2">
                 <br />
                  
               
               <%--  <input type="button" id="b1" class="form-control" value="SEND" for="kk" onclick="send_message();"/>--%>
               

                      <asp:Button  id="b1" class="form-control" value="SEND"  runat="server" OnClientClick="send_message();" OnClick="b1_Click" Text="SEND" />
