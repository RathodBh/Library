<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dept.aspx.cs" Inherits="Library_Management_System.webforms.update.dept" %>
    ...
    <div style="display:grid;height:100vh;place-items:center;background:url('../img/book2.png') no-repeat;background-size:cover ;">
        <div style="height:60vh;width:80vw;background:rgba(255, 216, 0,0.7);border-radius:15px;">
            <center>
                ...
                <asp:TextBox class="input" ID="dept2" runat="server" placeholder="Enter new Departments"></asp:TextBox>
                <br><br>
